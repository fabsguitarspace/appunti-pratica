...
Qui sotto trovi la procedura consigliata:

.. list-table:: Diteggiature nelle 12 tonalità
   :header-rows: 1
   :widths: 10 15 15
...
Esercitati finché tutte le diteggiature non diventano una vera e propria immagine mentale.

Assicurati di praticare le scale sia in senso ascendente che discendente.

Prova a usare queste diteggiature per improvvisare su progressioni II–V–I in tutte le tonalità.

Esempio:

* Dm7 G7 CΔ → usa la diteggiatura 6V2
* Gm7 C7 FΔ → usa la diteggiatura 5V2
* Cm7 F7 B♭Δ → usa la diteggiatura 6V2, ecc.
...
.. list-table:: Diteggiature 6V4 / 5V4 nelle 12 tonalità
   :header-rows: 1
   :widths: 10 15 15
...
* Dm7 G7 CΔ → usa la diteggiatura 6V4
